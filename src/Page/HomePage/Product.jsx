      ...
      {isOpen && (
        <Modal onClose={() => setIsOpen(false)}>
          <div className="p-5 w-180 h-130 overflow-y-auto bg-white rounded-2xl overflow-hidden no-scrollbar relative">
            ...
            <h1 className="text-2xl pb-4 text-black font-bold">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-2">
              ...
              <input
                ...
                className="bg-white w-[40%] px-5 py-2 rounded-2xl"
              />

              {/* Submit */}
              <button
                type="submit"
                className="bg-green-500 py-2 text-xl rounded-xl font-bold text-white"
              >
...
{delModal && (
      ...
      <div className="flex justify-between bg-white/18 px-4 py-5 rounded-xl mb-5">
        <div className="text-2xl tracking-wider font-bold text-black">
          Products
        </div>
        <button
          onClick={addEditModal}
          className="px-4 py-2 cursor-pointer bg-green-600 text-white font-medium rounded-md hover:bg-green-700 transition"
        >
          Add Products
        </button>
      </div>
              ...
              {data && data.length > 0 ? (
                <thead>
                  <tr className="bg-gray-200 text-black">
                    <th className=" py-1 px-2 text-center border border-gray-600 w-16 sticky top-0 z-20 bg-gray-200">
                      №
                    </th>
                    <th className="  text-center border border-gray-200 sticky top-0 z-20 bg-gray-200">
                      Images
                    </th>
                    <th className="  text-center border border-gray-200 sticky top-0 z-20 bg-gray-200">
                      Title
                      ...
                      <td className="py-1 border border-gray-600">
                        <button
                          onClick={() => handleEdit(item)}
                            className="text-white bg-orange-400 hover:bg-orange-500 px-2 py-1 mr-3 rounded"
                        >
                          Edit
                        </button>
                        <button
